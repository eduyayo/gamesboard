...
public class Connect4ControllerByMessagesTest {
	...
	private Connect4Controller controllerPigdroid;
	private UIBoardGameContext pigdroidUIGameContext;
	private Connect4Controller controllerEduyayo;
	...
	@Before
	public void setup() {
		controllerPigdroid = new Connect4Controller();
		controllerPigdroid.newGame();
		controllerEduyayo = new Connect4Controller();
	...
	private void the1000moves() {
		...
		Connect4Controller currentController = controllerEduyayo;
		int i = 0;
