...
public class MadelinetteControllerByMessagesTest {

	private MadelinetteController controllerPigdroid;
	private UIBoardGameContext pigdroidUIGameContext;
	private MadelinetteController controllerEduyayo;
	...
	@Before
	public void setup() {
		controllerPigdroid = new MadelinetteController();
		controllerPigdroid.newGame();
		controllerEduyayo = new MadelinetteController();
	...
	private void the1000moves() {
		...
		MadelinetteController currentController = controllerEduyayo;
		int i = 0;
		...
		for (int z = 1; z < 2; z++) {
			for (int y = 0; y < controllerEduyayo.getHeight(); y++) {
				for (int x = 0; x < controllerEduyayo.getWidth(); x++) {
					int zs = controllerEduyayo.getZIndex(x, y, z);
