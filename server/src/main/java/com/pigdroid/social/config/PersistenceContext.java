...
import com.pigdroid.hub.service.impl.GameServiceImpl;
import com.pigdroid.hub.service.impl.MessageServiceImpl;
import com.pigdroid.social.service.ContactService;
import com.pigdroid.social.service.UserService;
import com.pigdroid.social.service.impl.ContactServiceImpl;
import com.pigdroid.social.service.impl.RepositoryUserService;
...
@EnableJpaRepositories(basePackages = {
        "com.pigdroid.social.service",
        "com.pigdroid.social.repository",
        "com.pigdroid.hub.repository",
        "com.pigdroid.hub.service"
})
public class PersistenceContext {

    private static final String[] PROPERTY_PACKAGES_TO_SCAN = {
        "com.pigdroid.social.model",
        "com.pigdroid.hub.model.persistent"
    };
    ...
    DataSource dataSource() {
        ...
        try {
        	...
        	try {
        		dataSource = (DataSource) jndi.lookup("java:jboss/datasources/UnifiedPushDS");
    ...
    public UserService getUserService() {
    	return new RepositoryUserService();
    }
